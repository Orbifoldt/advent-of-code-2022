Output:
```
Reached end in 18 minutes
Reached end in 279 minutes
Got to end, then start, and then end again in 54 minutes
Got to end, then start, and then end again in 762 minutes
```
